<?php
  ...
  function wordpress_project_scripts () {
    wp_enqueue_style( 'wordpress-project-styles', get_template_directory_uri() . '/dist/css/main.css' , array(), _S_VERSION );
    wp_enqueue_style( 'wordpress-swiper-styles', 'https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.css', array(), _S_VERSION );
    wp_enqueue_style( 'wordpress-project-styles-rewrite', get_template_directory_uri(). '/style.css', array(), _S_VERSION );
    
    wp_enqueue_script( 'wordpress-project-scripts', get_template_directory_uri() . '/dist/js/main.js', array(), null, true );
    wp_enqueue_script( 'wordpress-swiper-scripts', 'https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js', array(), null, true );
  }
